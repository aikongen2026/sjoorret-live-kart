...
if ('serviceWorker' in navigator) window.addEventListener('load', () => navigator.serviceWorker.register('/sw.js?v=18.0', { updateViaCache: 'none' }).catch(() => {}));
initCatchLog();
updateWaterModeUI();
loadReferenceLayers();
